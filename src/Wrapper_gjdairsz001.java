 ...
 * 
 */
public class Wrapper_gjdairsz001 implements QunarCrawler {
...
//				.getBookingInfo(searchParam);
	...
	public void run(FlightSearchParam searchParam) {
		...
		try {
			...
			result = new Wrapper_gjdairsz001().process(html, searchParam);
	...
	public ProcessResultInfo process(String arg0, FlightSearchParam arg1) {
		...
		try {
			...
			for (Object object : flightArray) {
				...
				detail.setWrapperid("gjdairsz001");
